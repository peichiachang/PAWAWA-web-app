...
export type ActiveModal = 'feeding' | 'feedingLateEntry' | 'water' | 'elimination' | 'medication' | 'symptom' | 'settings' | 'blood' | 'bloodHistory' | 'bloodDetail' | 'kcalAdvice' | 'waterAdvice' | 'backup' | 'iap' | 'addCat' | 'editCat' | 'recordDetail' | 'weightRecord' | 'canLibrary' | 'feedLibrary' | 'recognitionTest' | 'recordMode' | null;
